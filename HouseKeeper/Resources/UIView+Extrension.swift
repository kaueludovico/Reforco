...
extension UIView {
    ...
    func centerAnchor(x: NSLayoutXAxisAnchor?, y: NSLayoutYAxisAnchor?, size: CGSize = .zero) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func roundedViews(corners: UIRectCorner, radius: CGFloat) {
